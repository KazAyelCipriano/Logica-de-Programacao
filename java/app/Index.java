...
public class Index {
    ...
    private static void ordenarEExibirResultados(String algoritmo, String ordem, int numElemen, ArrayList<Integer> lista) {
    ...
    public static void main(String[] args) {
        ...
        for (String algoritmoRodado : algs) { 
            ...
            for (int i = 1; i <= range * repet; i += range) {
                ...
                ordenarEExibirResultados(algoritmoRodado, "Crescente", qtndElementos * i, listaCres);
            }
            ...
            for (int i = 1; i <= range * repet; i += range) {
                ...
                // Chamada do método para processar e exibir os resultados
                ordenarEExibirResultados(algoritmoRodado, "Descrescente", qtndElementos * i, listaDecres);
            }
            ...
            for (int i = 1; i <= range * repet; i += range) {
                ...
                // Chamada do método para processar e exibir os resultados
                ordenarEExibirResultados(algoritmoRodado, "Aleatório", qtndElementos * i, listaAlea);
            }
        }
    }
}
